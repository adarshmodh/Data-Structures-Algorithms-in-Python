...
def decrypt(word):
  ...
  #   while(1):
  #     chk_val = tmp - ascii_word[i-1] + 26*x
      
  #     if ord('a') <= chk_val:
  #       ascii_word[i] = chk_val + ascii_word[i-1]
  #       break
  ...
  # output = []
  # for i in range(0,len(ascii_word)):
  #   if i == 0:  
  #     output.append(ascii_word[i]-1)
  #   else:
  #     output.append(ascii_word[i] - ascii_word[i-1])      
